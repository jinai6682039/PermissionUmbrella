...
public final class AcpOptions {
    ...
    public static class Builder {
        private static final String DEF_RATIONAL_MESSAGE = "相关权限需要您授权，否则将不能正常使用";
         ...
         * 申请权限理由框按钮
         *
         * @param rationalBtnText 申请权限理由框按钮文字
         * @return builder
         */
         ...
         * 拒绝框关闭按钮
         *
         * @param deniedCloseBtnText 拒绝框关闭按钮文字
         * @return builder
         */
         ...
         * 拒绝框跳转设置权限按钮
         *
         * @param deniedSettingText 拒绝框跳转设置权限按钮文字
         * @return builder
         */
